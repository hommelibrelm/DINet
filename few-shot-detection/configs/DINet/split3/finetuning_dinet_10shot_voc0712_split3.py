...
classes =  ('aeroplane', 'bicycle', 'bird', 'bottle', 'bus', 'car',
...
data = dict(
    ...
    workers_per_gpu=2,
        ...
        classes = classes, 
        ann_file='data/voc/voc_fewshot_split3/seed1/10shot_fewshot.json',
        img_prefix='data/voc/PascalVoc_CocoStyle/images'),
    val=dict(
        classes = classes, 
        ann_file='data/voc/PascalVoc_CocoStyle/annotations/pascal_test2007_split3.json',
        img_prefix='data/voc/PascalVoc_CocoStyle/images'),
    test=dict(
        classes = classes, 
        ann_file='data/voc/PascalVoc_CocoStyle/annotations/pascal_test2007_split3.json',
...
work_dir='./work_dirs/fintune_10shot_decoupled_myroi_split3_newblock/'
