...
data = dict(
    ...
    train=dict(
        ...
        classes = classes, 
        ann_file='data/voc/PascalVoc_CocoStyle/annotations/pascal_trainval0712_fewshot_split3.json',
...
work_dir='./work_dirs/base_training_decoupled_myroi_split3_newblock/'
