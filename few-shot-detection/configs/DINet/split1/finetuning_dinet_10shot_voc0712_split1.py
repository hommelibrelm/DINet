...
classes =  ('aeroplane', 'bicycle', 'boat', 'bottle', 'car', 'cat',
...
data = dict(
    ...
    workers_per_gpu=2,
        ...
        classes = classes, 
        ann_file='data/voc/voc_fewshot_split1/seed1/10shot_fewshot.json',
        img_prefix='data/voc/PascalVoc_CocoStyle/images'),
    val=dict(
        classes = classes, 
        ann_file='data/voc/PascalVoc_CocoStyle/annotations/pascal_test2007_split1.json',
        img_prefix='data/voc/PascalVoc_CocoStyle/images'),
    test=dict(
        classes = classes, 
        ann_file='data/voc/PascalVoc_CocoStyle/annotations/pascal_test2007_split1.json',
