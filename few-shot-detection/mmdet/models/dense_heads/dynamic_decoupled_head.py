...
from mmcv.cnn import normal_init, Scale, ConvModule
...
class StageDynamicDecoupledHead(RPNHead):
    """Stage of DynamicDecoupledHead.
    ...
    def __init__(self,
        ...
        self.stacked_convs = 4 #few-shot_base：4 few-shot_novel：1
        ...
        super(StageDynamicDecoupledHead, self).__init__(
    ...
    def forward_single(self, x, offset,scale):
        ...
        if self.use_tower_convs:
            ...
            reg_feat = F.normalize(reg_feat, p=2, dim=1)
            x = F.normalize(x, p=2, dim=1)  
            rpn_cls_score = self.rpn_cls(cls_feat) if self.with_cls else None
        ...
        return bridged_x, rpn_cls_score, rpn_bbox_pred
    ...
    def forward(self, feats, offset=None):
        ...
        if self.use_tower_convs:
            return multi_apply(self.forward_single, feats, offset, self.scales)
        else:
            return multi_apply(self.forward_single_wo_scale, feats, offset)
    ...
    def region_targets(self,
                       ...
                       label_channels=1,
                       unmap_outputs=True):
        """See :func:`StageDynamicDecoupledHead.get_targets`."""
    ...
    def get_targets(self,
        ...
        if isinstance(self.assigner, RegionAssigner):
            ...
            cls_reg_targets = super(StageDynamicDecoupledHead, self).get_targets(
                anchor_list,
                valid_flag_list,
                gt_bboxes,
                img_metas,
...
@HEADS.register_module()
class DynamicDecoupledHead(BaseDenseHead):
    """The DynamicDecoupledHead will predict more accurate region proposals, which is
    ...
    def __init__(self, num_stages, stages, train_cfg, test_cfg):
        super(DynamicDecoupledHead, self).__init__()
    ...
    def loss(self):
        """loss() is implemented in StageDynamicDecoupledHead."""
        pass

    def get_bboxes(self):
        """get_bboxes() is implemented in StageDynamicDecoupledHead."""
        pass
