...
root_path = '/mnt/disk/lm/mmdetection-2.20.0/data/'
SAMPLE_NUMBER = 5000  # 随机挑选多少个图片检查，
id_category = {1: 'point'}  # 改成自己的类别


def visiual():
    # 获取bboxes
    json_file = os.path.join(root_path, 'coco', 'annotations', 'instances_val2017.json')  # 如果想查看验证集，就改这里
    ...
    for i in random.sample(images, SAMPLE_NUMBER):  # 随机挑选SAMPLE_NUMBER个检测
        ...
        img = cv2.imread(os.path.join(root_path, 'coco', 'val2017',
