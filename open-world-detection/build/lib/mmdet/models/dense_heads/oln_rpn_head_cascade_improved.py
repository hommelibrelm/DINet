...
class OlnCascadeRPNImprovedHead(RPNHead):
    """OLN-RPN head.
    ...
    def __init__(self, 
        ...
        super(OlnCascadeRPNImprovedHead, self).__init__(
            in_channels,
...
@HEADS.register_module()
class OlnRPNImproved(BaseDenseHead):
    ...
    def __init__(self, num_stages, stages, train_cfg, test_cfg, init_cfg=None):
        super(OlnRPNImproved, self).__init__(init_cfg)
