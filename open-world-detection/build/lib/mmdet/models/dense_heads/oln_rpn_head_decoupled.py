...
class OlnRPNDecoupledHead(RPNHead):
    """OLN-RPN head.
    ...
    def __init__(self, 
        ...
        super(OlnRPNDecoupledHead, self).__init__(
            in_channels,
    ...
    def forward_single_wo_scale(self, x):
        """Forward feature map of a single scale level."""
        x = self.relu(self.rpn_conv(x))
    ...
    def forward(self, feats):
        if self.use_tower_convs:
            ...
            return multi_apply(self.forward_single_wo_scale, feats)
