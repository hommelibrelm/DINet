...
log_level = 'INFO'
load_from = None
resume_from = 'work_dirs/oln_box_cascade_uvo_improved_swin_decoupled_lr002/epoch_4.pth'
workflow = [('train', 1)]

evaluation = dict(interval=1, metric='bbox')

work_dir='./work_dirs/oln_box_cascade_uvo_improved_swin_decoupled_lr002_test/'
