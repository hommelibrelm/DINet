...
pretrained = 'trained_weights/deit_3_small_224_21k.pth'
norm_cfg = dict(type='LN', requires_grad=True)
custom_imports = dict(imports=['mmdet.core.optimizers.adan_t'], allow_failed_imports=False)
# model settings
model = dict(
    type='My',
...
work_dir='./work_dirs/oln_box_transformer_backbone_fpn_maedecoder_my/'