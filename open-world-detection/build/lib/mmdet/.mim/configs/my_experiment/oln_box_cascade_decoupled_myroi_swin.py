...
custom_imports = dict(
    imports=['mmdet.core.optimizers.adan_t', 'mmcv_custom.layer_decay_optimizer_constructor'],
...
model = dict(
    ...
    rpn_head=dict(
        ...
        stages=[
            dict(
                type='OlnCascadeRPNImprovedHead',
                in_channels=256,
                feat_channels=256,
    ...
    roi_head=dict(
        ...
        bbox_head=dict(
            ...
            loss_bbox_score=dict(type='SmoothL1Loss', loss_weight=1.0),
            )),
...
work_dir='./work_dirs/oln_box_cascade_decoupled_myroi_swin/'
